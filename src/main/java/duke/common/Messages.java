...
public class Messages {
    ...
    public static final String MESSAGE_FILE_NOT_FOUND = "There is no record data file found!";
    public static final String MESSAGE_NO_SUCH_TASK = "There is no such task related to such keyword: ";
    public static final String MESSAGE_INVALID_FILE = "The file used is invalid.\n";
    public static final String MESSAGE_INVALID_FILE_DATA = "The content used in file used is invalid!\n";
    ...
    public static final String MESSAGE_FOUND = "Here are the filtered tasks :\n";
    ...
    public static final String MESSAGE_INVALID_DATE_TIME_FORMAT = "Date and time format is invalid! "
            + "Please use format (dd//MM//yyyy HH:mm)";
